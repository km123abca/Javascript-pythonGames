...
class Zombie:
	def __init__(self,x,y,width,height):
		...
		self.longRangeAttacks=["Pursue","ReleaseBug","Pursue","Pursue","Pursue","Pursue","Pursue","Pursue"]
		# self.longRangeAttacks=["GrabAttack"]
		self.atkStartTime = 0
